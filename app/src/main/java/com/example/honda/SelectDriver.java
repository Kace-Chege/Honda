...
public class SelectDriver extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button select = (Button) findViewById(R.id.bt_select_1);
        Button select2 = (Button) findViewById(R.id.bt_select_2);
        Button select3 = (Button) findViewById(R.id.bt_select_3);
